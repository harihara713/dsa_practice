...
// PS: i copied above code from TheAlgorithms/Go - https://github.com/TheAlgorithms/Go/blob/master/constraints/constraints.go
// although there is no rocket science in the above code.
